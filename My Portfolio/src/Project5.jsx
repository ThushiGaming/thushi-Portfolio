...
export const Project5 = () => {
  return (
        ...
        <h1 className="md:text-7xl lg:text-9xl text-white mx-auto	md:pt-custom2 lg:pt-custom w-2/4 text-center pt-custom2 ">
          My Projects 
        </h1>
        <p className="md:text-1.5xl lg:text-1.5xl  text-white mx-auto w-1/3 pt-5 text-center ">
